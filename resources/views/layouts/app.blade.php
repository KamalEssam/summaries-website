        ...
        <div id="m_aside_left" class="m-grid__item  m-aside-left  m-aside-left--skin-dark ">    
            ...
            <div id="m_ver_menu" 
                ...
                <ul class="m-menu__nav ">
                    ...
                    <li class="m-menu__item  m-menu__item{{ preg_match("/^\/matches/",$_SERVER['REQUEST_URI']) ? '--active' : '' }}" aria-haspopup="true" >
                        <a  href="/matches" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-text">المباريات</span>
                        </a>
                    </li>

                    <li class="m-menu__item  m-menu__item{{ preg_match("/^\/leagues/",$_SERVER['REQUEST_URI']) ? '--active' : '' }}" aria-haspopup="true" >
                        <a  href="/leagues" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-text">الدوريات</span>
                        </a>
                    </li>

                    <li class="m-menu__item  m-menu__item{{ preg_match("/^\/teams/",$_SERVER['REQUEST_URI']) ? '--active' : '' }}" aria-haspopup="true" >
                        <a  href="/teams" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-text">الفرق</span>
                        </a>
                    </li>

                    <li class="m-menu__item  m-menu__item{{ preg_match("/^\/channels/",$_SERVER['REQUEST_URI']) ? '--active' : '' }}" aria-haspopup="true" >
                        <a  href="/channels" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-text">القنوات</span>
                        </a>
                    </li>

                    <li class="m-menu__item  m-menu__item{{ preg_match("/^\/commentators/",$_SERVER['REQUEST_URI']) ? '--active' : '' }}" aria-haspopup="true" >
                        <a  href="/commentators" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-text">المعلقين</span>
                        </a>
                    </li>
            ...
            <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                <div class="m-stack__item m-stack__item--right m-stack__item--middle m-stack__item--first">
                    <span class="m-footer__copyright">
                        <?php echo date("Y"); ?> &copy <a href="http://www.mol5sat.online" class="m-link">ملخصات</a>
                    </span>
                </div>  
